        ...
        const items = source.map((item) => (
            <tr key={item.id}>
                ...
                <td>
                    <div> 
                        {item.instock ? 
                        <span className="ps-status instock"> <i className="fa fa-check mr-2"></i>In Stock</span> :
                        <span className="out-of-stock"> <i className="fa fa-check mr-2"></i>Out of Stock</span>}
                    </div>
                </td>
                <td>
                    {item.instock && <a
